"""
Django settings for SEIKI project.
"""
...
WSGI_APPLICATION = 'SEIKI.wsgi.application'


# Database Configuration
# Uses PostgreSQL on Render and SQLite locally to avoid connection timeouts.
